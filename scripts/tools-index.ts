 ...
 * the real git date over it, but the JSON-LD below reads `page.updated`, so a
 * regenerate that left the key out would publish an empty `dateModified` until
 * the next sitemap run.
 */
