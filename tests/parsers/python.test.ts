...
async function parse(code: string, filePath = 'src/myapp/utils.py') {
...
describe('Python plugin — async function', () => {
  ...
  it('extracts async function with metadata', async () => {
    const result = await parse(code);
...
describe('Python plugin — class', () => {
  ...
  it('extracts class and method', async () => {
    const result = await parse(code);
...
describe('Python plugin — class inheritance', () => {
  ...
  it('extracts class with base classes in metadata', async () => {
    const result = await parse(code);
...
describe('Python plugin — dataclass', () => {
  ...
  it('detects dataclass decorator in metadata', async () => {
    const result = await parse(code);
...
describe('Python plugin — constant', () => {
  ...
  it('extracts ALL_CAPS assignments as constants', async () => {
    const result = await parse(code);
...
describe('Python plugin — typed variable', () => {
  ...
  it('extracts typed assignment as variable', async () => {
    const result = await parse(code);
...
describe('Python plugin — decorated function', () => {
  ...
  it('extracts function with decorator metadata', async () => {
    const result = await parse(code);
...
describe('Python plugin — error recovery', () => {
  ...
  it('extracts what it can, returns partial status', async () => {
    const result = await parse(code);
