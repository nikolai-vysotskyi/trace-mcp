...
the replacement is 21.1% over 18,319 measured calls (`docs/_data/response_tokens.json`,
...
or 21.1% with its two caveats — one machine's call mix, and a baseline that is
...
replacement is 21.1%, measured on 18,319 real calls with the responses counted on
the wire, published beside the ten tools that cost *more* than they replace.
