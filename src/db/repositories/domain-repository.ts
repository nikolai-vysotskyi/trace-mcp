...
import type { RawRoute, RawComponent, RawMigration, RawOrmModel, RawOrmAssociation, RawRnScreen } from '../../plugin-api/types.js';
import type { RouteRow, ComponentRow, MigrationRow, OrmModelRow, OrmAssociationRow, RnScreenRow } from '../types.js';
