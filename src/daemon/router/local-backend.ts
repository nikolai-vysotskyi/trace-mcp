...
export class LocalBackend implements Backend {
  ...
  async start(): Promise<void> {
    ...
    for (const p of createAllLanguagePlugins()) this.registry.registerLanguagePlugin(p);
    for (const p of createAllIntegrationPlugins()) this.registry.registerFrameworkPlugin(p);
