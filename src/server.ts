...
import { resolvePreset } from './tools/presets.js';
...
export function createServer(
  ...
  const META_KEYS = ['_hints', '_budget_warning', '_budget_level', '_duplicate_warning', '_dedup', '_optimization_hint', '_meta'] as const;
