...
| `get_plugin_registry` | List registered indexer plugins and edge types. | always |
...
| `scan_security` | Scan project files for OWASP Top-10 vulnerabilities (SQLi, XSS, command injection, path traversal, hardcoded secrets, insecure crypto, open redirects, SSRF —… | always |
