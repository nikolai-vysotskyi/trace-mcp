...
| `--text-disabled` | `#848484` | `#6D6D6D` |
| `--text-secondary` | `#999999` | `#595959` |
| `--text-primary` | `#E8E8E8` | `#1A1A1A` |
| `--text-display` | `#FFFFFF` | `#000000` |
| `--accent` | `#D71921` | `#B3151C` |

**Compute contrast ratios against the surface the text actually sits on.**
Both themes have three surfaces to check against:
- In light mode, the page is `#F5F5F5`, a surface is `#FFFFFF`, and a raised
  cell is `#F0F0F0`. `#6D6D6D` clears 4.5:1 on all three (4.75 / 5.17 / 4.54).
- In dark mode, the page is `#000000`, a surface is `#111111`, and a raised
  cell is `#1A1A1A`. `#848484` clears 4.5:1 on all three (5.63 / 5.07 / 4.66).
  The old `#666666` was only 3.66 / 3.29 / 3.01:1 and sat under AA across
  every dark-mode `scroll →` hint, footer label, and metadata element.
Quote the worst ratio of the three surfaces, not the best.
