...
description: "How quality_gates.rules in .trace.json overrides CLI defaults for cyclomatic complexity, security findings and coverage, with worked thresholds."
updated: 2026-09-03
---
