...
description: "Reproducible measurement of the input tokens trace-mcp saves over naive file loading when reviewing real merged pull requests in open-source repos."
updated: 2026-09-03
---
