...
| MCP tools advertised (default) | 28 `minimal` (~9.8K tok, default); 60 `standard` (~19K); {{ site.data.counts.tools }} `full` (~50K) | ~55 | ~28 | 15 all / 11 `analysis` / 7 `scout` (~7K tok) | 21 | 90 | 224 |
