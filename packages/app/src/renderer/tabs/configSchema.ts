...
export const CONFIG_SCHEMA: SectionDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'provider', label: 'Provider', type: 'select', options: ['ollama', 'openai'], defaultValue: 'ollama', showIf: 'enabled' },
      { key: 'base_url', label: 'Base URL', type: 'string', placeholder: 'http://localhost:11434', showIf: 'enabled' },
      ...
      { key: 'inference_model', label: 'Inference model', type: 'string', placeholder: 'gemma4-e4b', defaultValue: 'gemma4-e4b', showIf: 'enabled' },
      { key: 'fast_model', label: 'Fast model', type: 'string', placeholder: 'gemma4-e4b', defaultValue: 'gemma4-e4b', showIf: 'enabled' },
      { key: 'embedding_model', label: 'Embedding model', type: 'string', placeholder: 'qwen3-embedding:0.6b', defaultValue: 'qwen3-embedding:0.6b', showIf: 'enabled' },
      { key: 'embedding_dimensions', label: 'Embedding dimensions', type: 'number', placeholder: '1536', min: 1, showIf: 'enabled' },
      { key: 'summarize_on_index', label: 'Summarize on index', type: 'boolean', defaultValue: true, showIf: 'enabled' },
