export const settings = {
  ...
  'projects.staleCount_one': '{{n}} Ordner existiert nicht mehr',
  'projects.staleCount_other': '{{n}} Ordner existieren nicht mehr',
  'projects.removeStale_one': '{{n}} fehlenden Ordner entfernen',
  'projects.removeStale_other': '{{n}} fehlende Ordner entfernen',
  'projects.folderNotFound': 'Ordner nicht gefunden',
