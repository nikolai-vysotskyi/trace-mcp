...
export const guard = {
  ...
  'wizard.clients.failed': "Some assistants could not be configured. Check the errors above, then try again.",
  ...
  'wizard.project.failed': "Could not add the project to the background service.",
