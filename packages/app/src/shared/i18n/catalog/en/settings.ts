...
export const settings = {
  ...
  'projects.staleCount_one': '{{n}} folder no longer exists',
  'projects.staleCount_other': '{{n}} folders no longer exist',
  'projects.removeStale_one': 'Remove {{n}} missing folder',
  'projects.removeStale_other': 'Remove {{n}} missing folders',
  'projects.folderNotFound': 'Folder not found',
