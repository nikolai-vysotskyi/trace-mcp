...
export const settings = {
  ...
  'projects.staleCount_one': '{{n}} папка больше не существует',
  'projects.staleCount_few': '{{n}} папки больше не существуют',
  'projects.staleCount_many': '{{n}} папок больше не существует',
  'projects.staleCount_other': '{{n}} папки больше не существуют',
  'projects.removeStale_one': 'Удалить {{n}} отсутствующую папку',
  'projects.removeStale_few': 'Удалить {{n}} отсутствующие папки',
  'projects.removeStale_many': 'Удалить {{n}} отсутствующих папок',
  'projects.removeStale_other': 'Удалить {{n}} отсутствующей папки',
  'projects.folderNotFound': 'Папка не найдена',
