export const settings = {
  ...
  'projects.staleCount_one': '{{n}} dossier n’existe plus',
  'projects.staleCount_many': '{{n}} dossiers n’existent plus',
  'projects.staleCount_other': '{{n}} dossiers n’existent plus',
  'projects.removeStale_one': 'Retirer {{n}} dossier manquant',
  'projects.removeStale_many': 'Retirer {{n}} dossiers manquants',
  'projects.removeStale_other': 'Retirer {{n}} dossiers manquants',
  'projects.folderNotFound': 'Dossier introuvable',
