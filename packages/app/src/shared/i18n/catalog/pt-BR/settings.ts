export const settings = {
  ...
  'projects.staleCount_one': '{{n}} pasta não existe mais',
  'projects.staleCount_many': '{{n}} pastas não existem mais',
  'projects.staleCount_other': '{{n}} pastas não existem mais',
  'projects.removeStale_one': 'Remover {{n}} pasta ausente',
  'projects.removeStale_many': 'Remover {{n}} pastas ausentes',
  'projects.removeStale_other': 'Remover {{n}} pastas ausentes',
  'projects.folderNotFound': 'Pasta não encontrada',
