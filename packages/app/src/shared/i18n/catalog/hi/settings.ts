export const settings = {
  ...
  'projects.staleCount_one': '{{n}} फ़ोल्डर अब मौजूद नहीं है',
  'projects.staleCount_other': '{{n}} फ़ोल्डर अब मौजूद नहीं हैं',
  'projects.removeStale_one': '{{n}} गुम फ़ोल्डर हटाएँ',
  'projects.removeStale_other': '{{n}} गुम फ़ोल्डर हटाएँ',
  'projects.folderNotFound': 'फ़ोल्डर नहीं मिला',
