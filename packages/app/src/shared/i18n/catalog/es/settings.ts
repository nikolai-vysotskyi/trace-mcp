export const settings = {
  ...
  'projects.staleCount_one': '{{n}} carpeta ya no existe',
  'projects.staleCount_many': '{{n}} carpetas ya no existen',
  'projects.staleCount_other': '{{n}} carpetas ya no existen',
  'projects.removeStale_one': 'Quitar {{n}} carpeta faltante',
  'projects.removeStale_many': 'Quitar {{n}} carpetas faltantes',
  'projects.removeStale_other': 'Quitar {{n}} carpetas faltantes',
  'projects.folderNotFound': 'Carpeta no encontrada',
  ...
  /* ── Setup wizard ── */
  'app.setupWizard': "Asistente de configuración inicial",
  'app.runSetupWizard': "Ejecutar asistente…",
} as const;
